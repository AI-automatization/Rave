...
export type UserRestriction = 'create_room' | 'change_username' | 'send_message' | 'join_room' | 'upload_avatar' | 'use_chat';
export type NotificationType = 'friend_request' | 'friend_accepted' | 'watch_party_invite' | 'friend_online' | 'friend_watching' | 'support_reply' | 'dm_message' | 'admin_warning' | 'announcement' | 'maintenance' | 'promo' | 'update' | 'system' | 'warning';
...
export type ExtractionMethod = 'playerjs' | 'security-api' | 'yt-dlp' | 'playwright' | 'webview-session' | 'embed-api';
