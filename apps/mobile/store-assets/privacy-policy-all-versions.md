> # ⛔️ ИСТОРИЧЕСКИЙ ДОКУМЕНТ — аудит расхождений от 11.06.2026
>
> Снимок состояния на июнь. Перечисленные здесь версии политики устарели и содержат
> утверждения, опровергнутые кодом (см. PR #230, #245, #248 от 28–29.08.2026).
> Источник правды — `apps/mobile/src/constants/privacyPolicy.ts` и живые страницы
> `wewatch.uz/privacy-policy`, `/terms`, `/dmca`.
