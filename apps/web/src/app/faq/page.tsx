...
const faqs = [
  ...
  },
  {
    ...
    a: 'WeWatch использует Socket.io для передачи событий воспроизведения в реальном времени. Хозяин комнаты управляет воспроизведением: его пауза, перемотка или старт мгновенно передаются всем участникам. Встроенная коррекция дрейфа обеспечивает точность синхронизации менее 0,3 секунды.',
  },
  {
