  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-[#0A0A0F]">
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#7B72F8]/14 rounded-full blur-[140px]" />
        <div className="absolute top-1/3 left-1/3 w-64 h-64 bg-[#4C1D95]/18 rounded-full blur-[90px]" />
        <div className="absolute bottom-1/3 right-1/3 w-48 h-48 bg-[#6B63E8]/15 rounded-full blur-[70px]" />
        {/* Subtle grid */}
