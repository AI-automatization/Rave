...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${APP_URL}/ru/faq`,
    languages: hreflangFor('/ru/faq', APP_URL),
  },
  openGraph: {
    title: 'FAQ — Часто задаваемые вопросы | WeWatch',
    description: 'Всё о WeWatch: веб-синхронизация, бесплатный тариф и приложения iOS/Android, которые находятся в разработке.',
    url: 'https://wewatch.uz/ru/faq',
    type: 'website',
  },
...
const faqs = [
  {
    ...
    a: 'Откройте wewatch.uz в браузере. Нажмите «Создать комнату», вставьте ссылку на YouTube-видео и поделитесь ссылкой с другом. Приложения для iOS и Android находятся в разработке.',
  },
  {
  ...
  },
  {
    ...
    a: 'WeWatch поддерживает YouTube, VK Видео, Rutube, а также прямые .mp4 ссылки в веб-версии.',
  },
  {
    q: 'WeWatch бесплатный?',
    a: 'Основные функции совместного просмотра WeWatch бесплатны. В интерфейсе указан Pro-план с дополнительными функциями; доступность оплаты в production ещё требует подтверждения.',
  },
  {
    q: 'Работает ли WeWatch на Android?',
    a: 'Приложения WeWatch для iOS и Android находятся в активной разработке. Сейчас доступна веб-версия wewatch.uz, которая работает в браузере на телефоне и компьютере.',
  },
  {
    q: 'Можно ли смотреть вместе с телефона и компьютера одновременно?',
    a: 'Да. Участники могут открыть веб-версию в браузерах на iPhone, Android и компьютере и войти в одну синхронную комнату. Нативные приложения находятся в разработке.',
  },
  {
  ...
  },
  {
    ...
    a: 'Основные функции совместного просмотра WeWatch бесплатны. Pro-план указан отдельно и не меняет доступность базового watch party.',
  },
];
        ...
        <main className="max-w-4xl mx-auto px-6 py-14">
          ...
          <div className="mt-12 pt-8 border-t border-zinc-800/40">
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/ru/guides/smotret-youtube-vmeste" className="text-sm text-[#7B72F8] hover:text-[#9B92FF] transition-colors underline underline-offset-4">
                Как смотреть YouTube вместе →
              </Link>
              <Link href="/ru/guides/watch-party-besplatno" className="text-sm text-[#7B72F8] hover:text-[#9B92FF] transition-colors underline underline-offset-4">
                Что такое watch party →
              </Link>
              <Link href="/ru/guides/kino-s-drugom-onlayn" className="text-sm text-[#7B72F8] hover:text-[#9B92FF] transition-colors underline underline-offset-4">
