...
import {
  FaApple, FaPlay, FaMapMarkerAlt, FaChevronRight, FaArrowRight, FaEnvelope,
  FaLightbulb, FaDraftingCompass, FaCode, FaRocket,
} from 'react-icons/fa';
import { useTranslations } from 'next-intl';
import { PRODUCTS, TEAM, TECH, CONTACTS, CONTACT_EMAIL, TEZCODE_URL } from '@/data/tezcode';
      ...
      <section className="px-4 py-28 bg-[#0C0C14]">
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, x: -26 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.55 }}>
            ...
            <Link href="/features" className="inline-flex items-center gap-2 text-[#7B72F8] hover:text-[#a855f7] transition-colors text-sm font-semibold">
          ...
          <motion.a
            ...
            whileHover={{ y: -6 }}
            className="relative rounded-[28px] border border-[#7B72F8]/30 p-10 text-center overflow-hidden block"
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <span
                className="inline-flex items-center gap-2 h-12 px-8 rounded-xl text-white font-bold text-sm"
                style={{ background: 'linear-gradient(135deg, #7B72F8, #6B63E8)', boxShadow: '0 0 30px rgba(123,114,248,0.5)' }}
              >
