...
const jsonLd = {
  ...
  member: TEAM.map((m) => ({
    ...
    url: `https://wewatch.uz/team/${m.slug}`,
      ...
      <main className="min-h-screen bg-[#060608] text-white">
        ...
        <div className="relative max-w-5xl mx-auto px-4 py-12 md:py-16">
          ...
          <p className="text-xl text-zinc-400 mb-14 leading-relaxed max-w-2xl">
            WeWatch создаёт <Link href="/tezcode" className="text-[#7B72F8] hover:underline">tezcode</Link> — AI-first студия разработки из Ташкента. Инженеры и основатели продукта:
          </p>
