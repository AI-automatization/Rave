    ...
    '@graph': [
      ...
      },
      {
        '@type': 'BreadcrumbList', itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'Команда', item: 'https://wewatch.uz/team' },
        ...
        <div className="relative max-w-5xl mx-auto px-4 py-12 md:py-16">
          ...
          <section className={`${glass} mb-20 p-8 md:p-10 relative overflow-hidden`}>
            ...
            <div className="relative">
              ...
              <p className="text-zinc-400 leading-relaxed mb-7 max-w-2xl">
                {m.name} работает в <Link href="/tezcode" className="text-[#a99cff] hover:text-white underline underline-offset-2">tezcode</Link> — AI-first студии разработки, создавшей WeWatch и другие продукты.
              </p>
              <div className="flex flex-wrap gap-3">
                <Link href="/tezcode" className="inline-flex items-center gap-2 bg-[#7B72F8] hover:bg-[#6a63e8] text-white font-semibold px-5 py-2.5 rounded-xl transition-colors">О tezcode</Link>
          ...
          <section>
            <div className="flex items-center justify-between mb-6">
              ...
              <Link href="/team" className="text-sm text-zinc-400 hover:text-white transition-colors">Все →</Link>
            </div>
            <div className="grid grid-cols-3 gap-4">
              {others.map((p) => (
                <Link key={p.slug} href={`/team/${p.slug}`}
