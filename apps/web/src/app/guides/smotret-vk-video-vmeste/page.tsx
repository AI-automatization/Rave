...
export const metadata: Metadata = {
  title: 'Смотреть VK Видео вместе с друзьями онлайн — синхронно | WeWatch',
  description:
    'Как смотреть VK Видео вместе с друзьями синхронно. WeWatch открывает VK Видео во встроенном браузере и синхронизирует просмотр между iPhone, Android и вебом.',
  keywords: [
  ...
  alternates: { canonical: 'https://wewatch.uz/guides/smotret-vk-video-vmeste' },
  openGraph: {
    title: 'Смотреть VK Видео вместе | WeWatch',
    description: 'Синхронный просмотр VK Видео с друзьями — на любом устройстве.',
    url: 'https://wewatch.uz/guides/smotret-vk-video-vmeste',
    type: 'article',
  },
...
const jsonLd = {
  ...
  '@type': 'Article',
  headline: 'Как смотреть VK Видео вместе с друзьями',
  description: 'Гайд по совместному синхронному просмотру VK Видео через WeWatch.',
  ...
  inLanguage: 'ru',
  mainEntityOfPage: 'https://wewatch.uz/guides/smotret-vk-video-vmeste',
};
      ...
      <main className="min-h-screen bg-[#060608] text-white">
        <div className="max-w-3xl mx-auto px-4 py-16">
          ...
          <p className="text-xl text-zinc-400 mb-10 leading-relaxed">
            WeWatch открывает VK Видео во встроенном браузере и синхронизирует просмотр для всех участников. Пауза и перемотка применяются одновременно — на iPhone, Android и в вебе.
          </p>
          ...
          <section className="mb-10">
            ...
            <div className="space-y-4">
              {[
                { q: 'Работает с фильмами из VK?', a: 'Да, WeWatch открывает любые видео VK через встроенный браузер.' },
          ...
          <div className="bg-[#7B72F8]/10 border border-[#7B72F8]/30 rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Link href="/guides/smotret-rutube-vmeste" className="inline-flex items-center justify-center gap-2 border border-zinc-700 hover:border-zinc-500 text-zinc-300 font-medium px-6 py-3 rounded-xl transition-colors">Rutube вместе →</Link>
            </div>
          </div>
        </div>
      </main>
