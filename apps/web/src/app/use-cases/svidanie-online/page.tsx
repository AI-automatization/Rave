...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://wewatch.uz/use-cases/svidanie-online',
    type: 'article',
  },
...
const jsonLd = {
  ...
  inLanguage: 'ru',
  mainEntityOfPage: 'https://wewatch.uz/use-cases/svidanie-online',
};
        ...
        <div className="max-w-3xl mx-auto px-4 py-16">
          ...
          <div className="bg-[#7B72F8]/10 border border-[#7B72F8]/30 rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Link href="/use-cases/dalnie-otnosheniya" className="inline-flex items-center justify-center gap-2 border border-zinc-700 hover:border-zinc-500 text-zinc-300 font-medium px-6 py-3 rounded-xl transition-colors">Отношения на расстоянии →</Link>
            </div>
          </div>
        </div>
      </main>
