...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://wewatch.uz/tezcode' },
  openGraph: {
...
const products = [
  { name: 'WeWatch', tag: 'Наш продукт', desc: 'Совместный просмотр видео с друзьями онлайн — YouTube, VK, Rutube синхронно.', href: '/' },
