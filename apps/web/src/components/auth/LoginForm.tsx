  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="mt-3 w-full h-11 rounded-xl border border-zinc-700 bg-[#0A0A0F] hover:bg-zinc-900 hover:border-zinc-600 transition-all duration-200 flex items-center justify-center gap-3 text-sm font-medium text-zinc-300 active:scale-[0.98]"
      >
